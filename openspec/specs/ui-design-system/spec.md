...
Defines the visual design system for the control panel UI, including the warm earthy color palette, boxy aesthetic, animations, micro-interactions, and loading states.
