...
Handles iframe readiness polling, skeleton loading animation, and content reveal for sandbox preview in the control panel UI. Ensures sandboxes are fully available before displaying their content.
